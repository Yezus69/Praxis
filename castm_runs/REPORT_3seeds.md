...
## Run: `castm_runs/oracle/seed2`

| Game | S_rand | S_single | S_best | S_final | Progress | Retention | Forgetting |
|---|---|---|---|---|---|---|---|
| Alien-v5 | 182.500 | 561.500 | 755.000 | 755.000 | 1.511 | 1.000 | 0.000 |
| Defender-v5 | 3277.500 | 7855.000 | 10732.500 | 10732.500 | 1.629 | 1.000 | 0.000 |

- min progress = 1.511, min retention = 1.000, current progress = 1.629
- **Gate 21.2 (oracle 2-game):** P2=1.629 (>=0.90: True), R1=1.000 (>=0.90: True)
- **Gate 21.3 (inferred 2-game):** routing_acc=1.000 (>=0.99: True), P2>=0.90: True
- **Gate 21.4 (five-game):** min_P=1.511 (>=0.90: True); or min_R=1.000 & P_cur=1.629 (True)

### Oracle vs inferred address (spec 24)
| Game | oracle | inferred | route acc |
|---|---|---|---|
| Alien-v5 | 755.000 | 780.000 | 0.975 |
| Defender-v5 | 10732.500 | 10420.000 | 1.000 |
